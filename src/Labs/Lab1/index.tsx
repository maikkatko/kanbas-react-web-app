  ...
  return (
    <div id="wd-lab1">
      ...
      <div id="wd-lists">
        ...
        My favorite recipes:
        <ol id="wd-your-favorite-recipes">
          <li>Spaghetti</li>
          <li>Stir Fry</li>
      ...
      Please
      <a id="wd-git" href="https://github.com/maikkatko/kanbas-react-web-app">click here </a>
      to get to your git repo<br />
    </div>
  );
}
